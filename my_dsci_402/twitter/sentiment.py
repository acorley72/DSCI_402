...
#Returns a space if the character is a punctuation.
...
# for a passage of text, builds tuple of form (total_word_count, sentiment_word_count, sentiment_score_total)
